    ...
    tabItems(
      ...
      tabItem(
        ...
        tags$iframe(
          ...
          frameborder = 5, scrolling = "no",style = "overflow :hidden"
        )
      ),
        ...
        fluidRow(
          ...
          box(
            ...
            checkboxGroupButtons(
              inputId = "checkbar", label = "Label", choices = c("Féminin", "Masculin", "Total" ,"Pauvre","Non pauvre" ,"Rural" ,"Féminin Pauvre","Féminin Non pauvre","Masculin Non pauvre" , "Masculin Pauvre"), status = "danger",
              checkIcon = list(
      ...
      tabItem(
        ...
        fluidRow(
          ...
          box(
            ...
            checkboxGroupButtons(
              inputId = "checkline", label = "Label", choices = c("Féminin", "Masculin", "Total", "Rural", "Urbain"), status = "primary",
              checkIcon = list(
                yes = icon("ok", lib = "glyphicon"),
                no = icon("remove", lib = "glyphicon")
              ), selected = "Total"
      ...
      tabItem(
        ...
        fluidRow(
          box(
            ...
            "variable", "Subgroup:",
            c("Féminin", "Masculin", "Total" ,"Pauvre","Non pauvre" ,"Rural" ,"Féminin Pauvre","Féminin Non pauvre","Masculin Non pauvre" , "Masculin Pauvre"),
            options = list(
